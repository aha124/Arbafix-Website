...
function LoginContent() {
  ...
  const getErrorMessage = (errorType: string | null) => {
    switch (errorType) {
      case "AccessDenied":
        return "Not authorized. Your Google account is not permitted to access this admin area.";
      case "OAuthSignin":
      case "OAuthCallback":
      case "OAuthCreateAccount":
      case "EmailCreateAccount":
      case "Callback":
        return "There was a problem with the authentication. Please try again.";
      case "Configuration":
